...
//    M1A = Channel 0         M3A = Channel 4
//    M1B = Channel 1         M3B = Channel 5
//    M2A = Channel 2         M4A = Channel 6
//    M2B = Channel 3         M4B = Channel 7
//
...
void processSerial()
{
	...
	swSerial.write(serialData, serialMessageLength);
	swSerial.println(F(""));
